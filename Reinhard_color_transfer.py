# import cv2                           #used in data augmentation
# import numpy as np
# import os
# os.chdir=(r"E:\CV_projects")
# input_dir="input_dir/"
...
# template_img=cv2.imread("./template.jfif") #source img
...
#     print(input_img)
#     input_img=cv2.imread(input_dir+input_img)
...
#     input_img=cv2.cvtColor(input_img_lab,cv2.COLOR_Lab2BGR)
#     #cv2.imwrite(output_dir+"modified_"+input_img,input_img)

#     output_filename = "modified_" + input_img
#     cv2.imwrite(output_dir + output_filename, input_img)
